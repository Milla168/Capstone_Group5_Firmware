...
Usage:
    python simple_record.py              # Uses defaults (auto-detect port, 30 seconds)
    python simple_record.py COM4         # Specify port
    python simple_record.py COM4 60      # Specify port and duration
"""
...
def record(port, duration):
    ...
    filename = os.path.join('data', 'raw', f"crochet_{timestamp}.csv")
